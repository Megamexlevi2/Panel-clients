...
mkdir -p zpanelsite/Panel-clients

# Conteúdo do HTML dividido em partes
html_parts=(
    "<!DOCTYPE html>"
    "<html lang=\"en\">"
    "<head>"
    ...
    "        </a>"
    "        <a href=\"https://blockman-go.en.uptodown.com/android/download/1031033663-x\" download>"
...
for i in $(seq 1 200); do
    file_name="zpanelsite/Panel-clients/file_$i.html"
    # Adiciona uma parte do HTML ao arquivo
    echo "${html_parts[@]}" > "$file_name"
done

echo "200 arquivos HTML foram criados em zpanelsite/Panel-clients"